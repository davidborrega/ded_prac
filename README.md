...
Per tal de calcular la ordenació dels diferents TADs utilitzats per als esdeveniments esportius (en aquest cas, *OrdererVector* i *OrderVectorDictionary*) es fa servir el *comparator* de Java.
